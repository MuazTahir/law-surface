            ...
            <div className="modal-header">
              <h5 className="modal-title">
                ...
                <p className="mb-0 small">
                  Print the case file with the ability to specify the contents
                </p>
              </h5>
              <button
                type="button"
            ...
            <div className="modal-body">
              <div className="row">
                ...
                <div className="col-12 mb-4">
                  ...
                  >
                    Please choose the language of the content for printing:
                  </h3>
                ...
                <div className="col-12 mb-4">
                  <h3
                    ...
                    style={{ fontSize: "inherit", fontWeight: 700 }}
                  >
                    Please choose the data you want to print along with the case
                    file:
                  </h3>
                  <p className="small">
