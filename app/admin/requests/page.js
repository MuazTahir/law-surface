...
export default function Requests() {
    ...
    useEffect(() => {
        ...
        axios.post(process.env.NEXT_PUBLIC_API_SERVER+'/api/admin', {
            token: localStorage.getItem('token'),
            action: "get-requests-pending"
        }).then((resp) => {
                        ...
                        <td>
                            <button className="btn btn-success" onClick={e => {
                                ...
                                setControl({
                                    ...
                                    dialogContent: "Are you sure you want to accept this trial request?"
                                });
                            ...
                            <button onClick={e => {
                                ...
                                setControl({
                                    ...
                                    dialogContent: "Are you sure you want to decline this trial request?"
                                });
