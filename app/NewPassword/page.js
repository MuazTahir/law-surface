...
const languageData = {
  en: {
    ...
    signIn: 'Confirm Your New Password',
    emailPlaceholder: 'Enter email',
    passwordPlaceholder: 'Enter new password',
    passwordPlaceholder2: 'Confirm new password',
    signInButton: 'Confirm Password',
  ...
  ar: {
    ...
    signIn: 'أكد كلمة المرور الجديدة',
    emailPlaceholder: 'أدخل البريد الإلكتروني',
    passwordPlaceholder: 'أدخل كلمة المرور الجديدة',
    passwordPlaceholder2: 'تأكيد كلمة المرور الجديدة',
    signInButton: 'تسجيل الدخول',
    rightsReserved: 'خدمة السحابة من LS. جميع الحقوق محفوظة. 2024',
    isoCertificate:
      'حاصلة على شهادة ISO 27001 لأمن المعلومات، الأمن السيبراني، حماية الخصوصية ونظام إدارة أمن المعلومات',
  },
        ...
        <div className={`col-sm-12 ${styles.login_section_wrapper}`}>
          <div className={`my-auto ${styles.login_wrapper}`}>
            <div className={`${styles.brand_wrapper}`}>
              <div
                style={{ width: '177px' }}
                className={language === 'ar' ? 'text-right ms-2 ' : 'text-left me-2  '}
              >
                <svg
          ...
          <div className='w-100'>
  <h1
    className={language === 'ar' ? 'text-center' : `text-center ${styles.welcome_text}`}
    style={{ fontSize: '18px', marginTop: '19px' }}
  >
    {welcome}
  </h1>
  <p className={`text-center mt-3 pt-1 mb-4 ${styles.signInText}`}>{signIn}</p>
