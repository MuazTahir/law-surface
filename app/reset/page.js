...
const languageData = {
  en: {
    ...
    signIn: 'Confirm Your Email Address',
    emailPlaceholder: 'Enter email',
    passwordPlaceholder: 'Enter password',
    signInButton: 'Send Email',
  ...
  ar: {
    ...
    signIn: 'تأكيد بريدك الإلكتروني',
    emailPlaceholder: 'أدخل البريد الإلكتروني',
    passwordPlaceholder: 'أدخل كلمة المرور',
    signInButton: 'إرسال البريد الإلكتروني',
    rightsReserved: 'خدمة السحابة من LS. جميع الحقوق محفوظة. 2024',
    isoCertificate:
      'يحمل شهادة ISO 27001 لأمن المعلومات، والأمن السيبراني، وحماية الخصوصية ونظام إدارة أمن المعلومات',
  },
      ...
      <div className={`col-sm-12 ${styles.login_section_wrapper}`}>
        ...
        <div className={`${styles.login_portal_page}`}>
            <div className='w-100'>
              ...
              <p className={`text-center mt-3 pt-2 mb-4  ${styles.signInText} `}>{signIn}</p>
              ...
              <div className={`form-group mb-4 ${styles.form_group}`}>
                ...
                <div className={`form-group  mb-3 mt-3 ${styles.form_group}`}>
