    ...
    <div className="m-5" >
      <div className="d-flex flex-md-wrap justify-content-start gap-3" >
        <div className="d-flex align-items-center ">
          ...
          {/* <div  > */}
          <i class="fal fa-file-export me-3"></i>
          {/* </div> */}
          {/* <div> */}
          <h4 style={{ color: "#0d6efd" }} className="mb-0 lh-lg" >Report Clients</h4>
          {/* </div> */}
        </div>
      ...
      <div id="main" className="bg-white p-4">
        ...
        <div className="d-md-flex justify-content-center gap-5">
          ...
          Drop here
              ...
              {/* Public Data Section */}
              <div className="d-md-flex justify-content-center gap-5 border-bottom mt-4">
