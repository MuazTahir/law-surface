...
<div className="d-flex flex-md-wrap justify-content-start gap-3" >
        <div className="d-flex align-items-center ">
          ...
          {/* <div  > */}
          <i class="fal fa-file-signature m-2"></i>
          {/* </div> */}
          {/* <div> */}
          <h4 style={{ color: "#0d6efd" }} className="mb-0 lh-lg" >Report Procedures</h4>
          {/* </div> */}
        </div>
      ...
      <div id="main" className="bg-white p-4">
        ...
        <div className="mt-5">
            ...
            <div className="d-flex flex-column flex-md-row gap-4 pe-3 mt-3">
              ...
              <div>
                ...
                <div className="d-flex align-items-center">
                  ...
                  <p className="small pt-4 ms-2">All Clients</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="d-flex flex-column flex-md-row gap-4 pe-3 mt-3">
              <div>
                <h6 className="small">Procedures Type</h6>
              ...
              <div>
                <h6 className="small">Report Type</h6>
                <select className="form-select mt-2" style={{ width: "200px", maxHeight: "100px", overflowY: "scroll" }}>
                  <option>Select...</option>
                  <option>Default report</option>
                  <option>Tilted Procedure & Date</option>
                  <option>Tilted Procedure, Date & Details</option>
                </select>
              </div>
            </div>
            ...
            <div className="d-flex flex-column flex-md-row gap-4 pe-3 mt-3">
              ...
              <div>
                <h6 className="small">Case Court</h6>
                <select className="form-select mt-2" style={{ width: "200px", maxHeight: "100px", overflowY: "scroll" }}>
