...
export default function Home() {
  ...
  useEffect(() => {
    clientsAPI
      .clients({ action: 'getClients' })
      .then((resp) => {
        setCLients(resp.data.values);
      })
      .catch(() => {
        toast.error('Oops, cannot load clients list');
      });
  }, []);
  ...
  const downloadReport = (data) => {
    let columns = [...document.querySelectorAll('#userColumns #drop-area2 > h6')].map((item) => {
    ...
    api
      ...
      .catch((err) => {
        toast.error('Oops, the report could not be generated');
      });
  };
      ...
      <div className="m-5">
        <div className="d-flex flex-md-wrap justify-content-start gap-3">
          <div className="d-flex align-items-center ">
            {/* <div  > */}
            <i class="fal fa-file-invoice m-2"></i>
            {/* </div> */}
            {/* <div> */}
            <h4
              style={{ color: '#0d6efd' }}
                ...
                <div className="d-flex flex-column flex-md-row gap-4 pe-3 mt-3">
                  <div>
                    ...
                    <select
                      ...
                      className="form-select mt-4 pt-2"
                      style={{ width: '240px', maxHeight: '100px', overflowY: 'scroll' }}
                    >
