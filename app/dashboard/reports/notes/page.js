...
export default function Home() {
  ...
  return <div  >
    ...
    <div className="m-5" >
      <div className="d-md-flex flex-md-wrap justify-content-start gap-3" >
        <div className="d-flex align-items-center ">

          {/* <div  > */}
          <i class="fal fa-comment-alt m-2"></i>
          {/* </div> */}
          {/* <div> */}
          <h4 style={{ color: "#0d6efd" }} className="mb-0 lh-lg" >Report Notes</h4>
          {/* </div> */}
        </div>
      ...
      <div id="main" className="bg-white p-4">
        ...
        <div className="mt-5">
          ...
          <div>
            ...
            <div className="d-flex flex-column flex-md-row gap-4 pe-3 mt-3">
              <div>
                <h6 className="small">Clients Name</h6>
