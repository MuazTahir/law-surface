...
<div className="d-flex flex-md-wrap justify-content-start gap-3" >
        <div className="d-flex align-items-center ">
          ...
          {/* </div> */}
          {/* <div> */}
          <h4 style={{ color: "#0d6efd" }} className="mb-0 lh-lg" >Report Disputing Parties</h4>
          {/* </div> */}
        </div>
          ...
          <div className="border rounded p-2">
            ...
            <div >
              ...
              <div className="d-md-flex justify-content-space-between mt-4 gap-5 border-bottom">
                <h6 className="mx-5 ms-3 ps-3">Disputing Parties Data</h6>
                <i className="fal fa-user mx-5 ms-3 ps-3"></i>
