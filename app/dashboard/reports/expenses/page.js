...
<div className="d-flex flex-md-wrap justify-content-start gap-3" >
      {/* <div className="d-md-flex justify-content-center gap-3 " > */}
        <div className="d-flex align-items-center ">
          ...
          {/* <div  > */}
          <i class="fal fa-coins m-2"></i>
          {/* </div> */}
          {/* <div> */}
          <h4 style={{ color: "#0d6efd" }} className="mb-0 lh-lg" >Report Expenses</h4>
          {/* </div> */}
        </div>
      ...
      <div id="main" className="bg-white p-4">
        ...
        <div className="d-md-flex justify-content-center gap-5">
          <div className="border rounded p-2">
            ...
            <div >
              ...
              <div className="d-md-flex justify-content-space-between mt-4 gap-5 border-bottom">
                <h6 className="mx-5 ms-3 ps-3">Expenses Data</h6>
          ...
          Drop here
              ...
              {/* Public Data Section */}
              <div className="d-md-flex justify-content-start gap-5 mt-4">
  ...
  <div className="mt-5">
    ...
    <div>
      <div className="ms-3 mt-5">
        <div style={{ background: "#e9ecef", height: "30px" }} className="me-5 pe-5">
          <h6 className="pt-2 pb-4 ps-2 small">Other Options</h6>
        </div>
      </div>
      <div className="d-flex flex-column flex-md-row gap-4 pe-3 mt-3">
        <div>
          <h6 className="small">Expenses Category</h6>
        ...
        <div>
          <h6 className="small">Report Method</h6>
          <div className="d-flex align-items-center">
          <select className="form-select mt-3 pt-2" style={{ width: "240px", maxHeight: "100px", overflowY: "scroll" }}>
            <option>Categories Total</option>
            <option>All Expenses In Detail</option>
            {/* <option>Moaz Abdel Rehman Abboud - معاذ عبد الرحمن عبود</option>
            <option>Lahn Al-Ramal Trading - لحن الرمال للتجارة</option> */}
            </select>
