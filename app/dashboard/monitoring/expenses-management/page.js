...
export default function CategoryShow() {
    ...
    useEffect(() => {        
        ...
        axios.post(process.env.NEXT_PUBLIC_API_SERVER+"/api/dashboard/expenses", {
    ...
    return (
        <div  className="catrgoryDivMain">
            ...
            <div className="col-md-4 me-3">
                        ...
                        <MyTab categories={mycategory} onExpenseAdd={onExpenseAdd} onCategoryAdd={onCategoryAdd} />
                        ...
                        <>
                            <div className="d-flex justify-content-between mb-2 bg-white align-items-center p-2">
                                <div className="d-flex">
                                    <div className="me-3"><span className=""><b>Category:</b></span><small >{currentCategory.catEnglishName}</small></div>
                                    <div className="me-3"><span><b>Office Assets:</b></span>{currentItems.fromAssets?<small>YES</small>:<small>No office Assist</small>}</div>
                                    <div className="me-3"><span><b>Annual Decrement</b></span></div>
                                </div>
                                <div>
                                ...
                                <div className="row m-0 bg-white">
                                    <div className="col-md-6 d-flex">
                                        ...
                                        <div className="p-2">
                                            ...
                                            <div className="d-flex">
                                                <input className="form-control" type="text" placeholder="Search by note" onChange={(e) => setSearchNote(e.target.value)} />
                                                <div>
                                    ...
                                    <div className="col-md-6">
                                        ...
                                        <div className="mt-2 align-items-center d-flex">
                                            <span className="me-2">From</span>
                                            <input className="w-25 form-control me-2" type="date" onChange={(e) => setLowerFromDate(e.target.value)} />
                                            <span className="me-2">To</span>
                                            <input className="w-25 form-control me-2" type="date" onChange={(e) => setLowerToDate(e.target.value)} />
                                            <button className="btn btn-primary" onClick={handleDateSort}>Sort</button>
                                        </div>
                                    </div>
                                </div>
